...
<!-- wildling:preamble -->
**Docs:** [Website](https://dotmonk.github.io/wildling/) · [Sandbox](https://dotmonk.github.io/wildling/sandbox.html) · [Syntax](https://dotmonk.github.io/wildling/syntax.html) · [Source](https://github.com/dotmonk/wildling/tree/main/elixir)

**Registry:** [Hex](https://hex.pm/packages/wildling)
...
```elixir
{:wildling, git: "https://github.com/dotmonk/wildling.git", tag: "v2.0.2", path: "elixir"}
```

**Registry:** `{:wildling, "~> 2.0"}` on Hex

```elixir
w = Wildling.create(["Year 19##"])
