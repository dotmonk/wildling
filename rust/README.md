...
<!-- wildling:preamble -->
**Docs:** [Website](https://dotmonk.github.io/wildling/) · [Sandbox](https://dotmonk.github.io/wildling/sandbox.html) · [Syntax](https://dotmonk.github.io/wildling/syntax.html) · [Source](https://github.com/dotmonk/wildling/tree/main/rust)

**Registry:** [crates.io](https://crates.io/crates/wildling)
...
```toml
wildling = { git = "https://github.com/dotmonk/wildling", tag = "v2.0.2", path = "rust" }
```
