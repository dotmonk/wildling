...
public final class ParsePattern {
    ...
    private static Token dictionaryTokenizer(String part, Map<String, List<String>> dictionaries) {
        ...
        if (options == null
            ...
            return new Token(TokenOptions.of(List.of(part), 1, 1, part));
        }
        List<String> words = dictionaries.get(options.string != null ? options.string : "");
        options.variants = words != null ? words : List.of();
    ...
    private static Token partToToken(String part, Map<String, List<String>> dictionaries) {
        ...
        tokenizers.put('#', simpleTokenizer("0123456789"));
        tokenizers.put('@', simpleTokenizer("abcdefghijklmnopqrstuvwxyz"));
        tokenizers.put('*', simpleTokenizer("abcdefghijklmnopqrstuvwxyz0123456789"));
        tokenizers.put('-', simpleTokenizer(
                "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"));
        tokenizers.put('!', simpleTokenizer("ABCDEFGHIJKLMNOPQRSTUVWXYZ"));
        tokenizers.put('?', simpleTokenizer("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"));
        tokenizers.put('&', simpleTokenizer(
                "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"));
        tokenizers.put('%', p -> dictionaryTokenizer(p, dictionaries));
        tokenizers.put('$', ParsePattern::wordsTokenizer);
        ...
        if (isEscapedToken) {
            return new Token(TokenOptions.of(List.of(part.substring(1)), 1, 1, part));
        }
        return new Token(TokenOptions.of(List.of(part), 1, 1, part));
    }
    ...
    public static List<Token> parse(String inputPattern, Map<String, List<String>> dictionaries) {
        Map<String, List<String>> dicts = dictionaries != null ? dictionaries : Map.of();
